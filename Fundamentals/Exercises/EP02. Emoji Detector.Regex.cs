...
namespace EP02._Emoji_Detector_Reg
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            long threshold = CalculateThreshod(allDigits);
            ...
            foreach (Match emojiMatch in emojiMatches)
            {
                ...
                long coolnes = GetASCIISum(emojiText);
        ...
        private static long CalculateThreshod(MatchCollection digits)
        {
            long result = 1; //започва умножението от 1, защото ако е нула->целият резултат ще е нула
